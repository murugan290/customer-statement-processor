...
public class SwaggerConfig {
    ...
    private static final Set<String> DEFAULT_CONSUMES = new HashSet<>(Arrays.asList("multipart/form-data"));
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                ...
                .description("RESTful API for customer statement processor")
                .version("version 1.0")
